...
| Operations implemented     | **4912 / 8422**                                                          |
| Overall operation coverage | **58.3%** █████░░░░░                                                     |
| Services at 100%           | **92**                                                                   |
| CI                         | `bun test` → **1617 pass / 86 skip / 0 fail** (168 files) + server build |
...
| imagebuilder         | rest-json | 37/77  | 48%      |
| s3                   | rest-xml  | 51/111 | 46%      |
| sts                  | query     | 4/11   | 36%      |
| iam                  | query     | 34/176 | 19%      |
| logs                 | json      | 16/113 | 14%      |
