...
const allThingsKey = "_allThings";
const allThingTypesKey = "_allThingTypes";
const allThingGroupsKey = "_allThingGroups";
const allCertsKey = "_allCerts";
const allPoliciesKey = "_allPolicies";
const allRulesKey = "_allRules";
...
const jobExecutionsForJobKey = (jobId: string) => `_jobExecsForJob:${jobId}`;
const jobExecutionsForThingKey = (thingName: string) =>
  `_jobExecsForThing:${thingName}`;
const allJobsKey = "_allJobs";
const allJobTemplatesKey = "_allJobTemplates";
const allCommandsKey = "_allCommands";
const allCommandExecutionsKey = "_allCommandExecutions";
const caCertKey = (id: string) => `caCert:${id}`;
const allCACertsKey = "_allCACerts";
const registrationCodeKey = "registrationCode";
const certProviderKey = (name: string) => `certProvider:${name}`;
const allCertProvidersKey = "_allCertProviders";
...
const allCustomMetricsKey = "_allCustomMetrics";
const dimensionKey = (name: string) => `dimension:${name}`;
const allDimensionsKey = "_allDimensions";
const detectTaskKey = (id: string) => `detectTask:${id}`;
const allDetectTasksKey = "_allDetectTasks";
const billingGroupKey = (name: string) => `billingGroup:${name}`;
const allBillingGroupsKey = "_allBillingGroups";
...
const allDynamicThingGroupsKey = "_allDynamicThingGroups";
const fleetMetricKey = (name: string) => `fleetMetric:${name}`;
const allFleetMetricsKey = "_allFleetMetrics";
const indexingConfigKey = "indexingConfig";
const registrationTaskKey = (id: string) => `registrationTask:${id}`;
const allRegistrationTasksKey = "_allRegistrationTasks";
